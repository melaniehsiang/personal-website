  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <main className="min-h-screen">
        ...
        <section id="about" data-page-title="About" className="ml-48 mr-auto flex min-h-screen w-[min(900px,calc(100%-17rem))] items-center justify-start py-20">
        ...
        <section id="projects" data-page-title="Projects" className="ml-48 mr-auto min-h-screen w-[min(900px,calc(100%-17rem))] py-28">
          <div className="max-w-3xl text-left">
            <h2 className="font-serif text-[clamp(2.25rem,5vw,4.5rem)] leading-[0.95] tracking-[-0.045em] text-foreground">
              Projects
            </h2>
